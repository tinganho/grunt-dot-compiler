 ...
 */
 ...
 module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('compile-template', 'prepares and combines any type of template into a script include', function() {
    // grap the filepattern
    var files = grunt.file.expandFiles(this.file.src);
    // create the hogan include
    var src = grunt.helper('template-client', files, this.data.options);
    // write the new file
  ...
  grunt.registerHelper('compile-template', function(files, options) {
