...
module.exports = function(grunt) {
	...
	grunt.registerMultiTask('template-client', 'prepares and combines any type of template into a script include', function() {
	...
	grunt.registerHelper('template-client', function(files, options) {
		var js = '';
